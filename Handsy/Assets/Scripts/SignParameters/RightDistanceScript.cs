...
public class RightDistanceScript : MonoBehaviour
{    
    public SortedDictionary<char, HandsyDistances> rightLetters;
    ...
    public void Awake(){
        ...
        rightLetters['g'] = new HandsyDistances(
            ...
            new float[2] {0.058918f, 0.07161678f}, 
            new float[2] {0.07474881f, 0.2f},
            new float[2] {0.0f, 0.0462727f},
            new float[2] {0.0f, 0.04249761f},
            new float[2] {0.0f, 0.0419693f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.down
        );
        rightLetters['h'] = new HandsyDistances(
            ...
            new float[2] {0.05273569f, 0.0697866f}, 
            new float[2] {0.04306256f, 0.2f},
            new float[2] {0.09267862f, 0.2f},
            new float[2] {0.0f, 0.03980615f},
            new float[2] {0.0f, 0.04108002f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.back
        );
        ...
        rightLetters['k'] = new HandsyDistances(
            ...
            // new float[2] {0.09455667f, 0.1073715f},
            // new float[2] {0.08793048f, 0.1136698f},
        ...
        rightLetters['l'] = new HandsyDistances(
            ...
            new float[2] {0.08313951f, 0.2f}, 
            new float[2] {0.0922984f, 0.2f},
            new float[2] {0.0f, 0.04470721f},
            new float[2] {0.0f, 0.04352567f},
            new float[2] {0.0f, 0.04120598f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['m'] = new HandsyDistances(
            ...
            new float[2] {0.0f, 0.05462674f}, 
            new float[2] {0.0f, 0.0393761f},
            new float[2] {0.0f, 0.03917431f},
            new float[2] {0.0f, 0.03913261f},
            new float[2] {0.0f, 0.03589288f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['n'] = new HandsyDistances(
            ...
            new float[2] {0.04668895f, 0.05911779f}, 
            new float[2] {0.0f, 0.04635527f},
            new float[2] {0.0f, 0.04922039f},
            new float[2] {0.0f, 0.046744f},
            new float[2] {0.0f, 0.04033361f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        ...
        rightLetters['p'] = new HandsyDistances(
            ...
            new float[2] {0.03852916f, 0.06715829f}, 
            new float[2] {0.07084803f, 0.2f},
            new float[2] {0.03795689f, 0.08799083f},
            new float[2] {0.0f, 0.04715325f},
        ...
        rightLetters['r'] = new HandsyDistances(
            ...
            new float[2] {0.03616431f, 0.0556614f}, 
            new float[2] {0.07663275f, 0.2f},
            new float[2] {0.03244827f, 0.09655226f},
            new float[2] {0.0f, 0.04580658f},
            new float[2] {0.0f, 0.04111487f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['s'] = new HandsyDistances(
            ...
            new float[2] {0.03577849f, 0.04549649f},
            new float[2] {0.03177527f, 0.04601922f},
            new float[2] {0.03063347f, 0.04420514f},
            new float[2] {0.03120028f, 0.04253057f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        ...
        rightLetters['u'] = new HandsyDistances(
            'u',
            new float[2] {0.05031939f, 0.05878915f}, 
            new float[2] {0.07907277f, 0.1068481f},
            new float[2] {0.0847689f, 0.1151397f},
            new float[2] {0.04059562f, 0.0519545f},
            new float[2] {0.03686045f, 0.04459706f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['v'] = new HandsyDistances(
            ...
            new float[2] {0.08059828f, 0.11387f},
            new float[2] {0.04278581f, 0.05508086f},
            new float[2] {0.0380976f, 0.04767102f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['w'] = new HandsyDistances(
            'w',
            new float[2] {0.0491581f, 0.06422813f}, 
            new float[2] {0.09632107f, 0.1113685f},
            new float[2] {0.09020065f, 0.1153525f},
            new float[2] {0.07762665f, 0.106867f},
            new float[2] {0.04067278f, 0.06068439f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['x'] = new HandsyDistances(
            'x',
            // new float[2] {0.05263569f, 0.07345853f}, 
            // new float[2] {0.06247689f, 0.1004247f},
            // new float[2] {0.03821471f, 0.05228221f},
            // new float[2] {0.03803716f, 0.04867741f},
            // new float[2] {0.03751209f, 0.04623834f},
            new float[2] {0.05263569f, 0.07345853f}, 
            new float[2] {0.06f, 0.1004247f},
            new float[2] {0.0f, 0.05228221f},
            new float[2] {0.0f, 0.04867741f},
            new float[2] {0.0f, 0.04623834f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.left
        );
        rightLetters['y'] = new HandsyDistances(
            'y',
            new float[2] {0.06852327f, 0.09212723f}, 
            new float[2] {0.03763456f, 0.04704598f},
            new float[2] {0.03494919f, 0.04862337f},
            new float[2] {0.03552056f, 0.04573791f},
            new float[2] {0.06954307f, 0.09592429f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['z'] = new HandsyDistances(
            'z',
            new float[2] {0.04784695f, 0.06422385f}, 
            new float[2] {0.0805859f, 0.1073025f},
            new float[2] {0.03717768f, 0.04660995f},
            new float[2] {0.03401138f, 0.04881676f},
            new float[2] {0.03213888f, 0.04438335f},
            Leap.Unity.PointingType.RelativeToHorizon,
            targetTransform,
            Vector3.forward
        );
        rightLetters['0'] = new HandsyDistances(
            '0',
            new float[2] {0.06191183f, 0.07558662f}, 
            new float[2] {0.05576184f, 0.101362f},
            new float[2] {0.05214009f, 0.08414167f},
